...
# base_validation_score = base.score(X_validation, y_validation)
# base_test_score = base.score(X_test, y_test)

# log(f"Base train score: {base_train_score}")
# log(f"Base validation score: {base_validation_score}")
...
# bagging_validation_score = bagging.score(X_validation, y_validation)
# bagging_test_score = bagging.score(X_test, y_test)

# log(f"Bagging train score: {bagging_train_score}")
# log(f"Bagging validation score: {bagging_validation_score}")
...
# paramsearch.search(X_train, y_train, 2)
...
# stump_validation_score = stump.score(X_validation, y_validation)
# stump_test_score = stump.score(X_test, y_test)

# log(f"STUMP train score: {stump_train_score}")
# log(f"STUMP validation score: {stump_validation_score}")
...
# adaboost_validation_score = adaboost.score(X_validation, y_validation)
# adaboost_test_score = adaboost.score(X_test, y_test)

# log(f"Adaboost train score: {adaboost_train_score}")
# log(f"Adaboost validation score: {adaboost_validation_score}")
